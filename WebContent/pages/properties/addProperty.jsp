	...
	<fieldset>
		...
		<table class="propertyForm">
			...
			<tr class="even">
				...
				<td width="30%"><sj:select href="listCities" id="city" name="property.city.id" list="citiesList" listKey="id" listValue="fullName" emptyOption="false" headerValue="-- Select City --" headerKey="-1" reloadTopics="reloadCitiesList" onChangeTopics="reloadCompoundsAndDistrictsList" required="true"/></td>
				...
				<td width="30%"><sj:select href="listCompounds" id="compound" name="property.compound.id" list="compoundsList" listKey="id" listValue="fullName" emptyOption="false" headerValue="-- Select Compound --" headerKey="-1" reloadTopics="reloadCompoundsAndDistrictsList" onChangeTopics="disableAllOthers"/></td>
			...
			<tr class="odd otherLocationData">
				...
				<td width="30%"><sj:select href="listDistricts" id="district" name="property.district.id" list="districtsList" listKey="id" listValue="fullName" emptyOption="false" headerValue="-- Select District --" headerKey="-1" reloadTopics="reloadCompoundsAndDistrictsList" onChangeTopics="reloadZonesList" /></td>
