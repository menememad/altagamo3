...
//			}
			// My updates...
			watermark = false;//No watermark image included in the page
			watermarkPath = "/scripts/watermark.png";
			watermarkPosition = "top-right";
			opacity = (255/(100/50)); //Opacity (Default: 50)
			className = watermark; //The class name for the image to be watermarked
