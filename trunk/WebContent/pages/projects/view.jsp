...
> <center><s:property value="project.description"/></center>  </sj:div>		
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	 	
<a onclick="exportWindow('<s:property value="project.id"/>')" href="javascript:;"  style="width:75px" ><img alt="" src="static/tgm3/images//export/pdf.jpg"/>  </a>
               </p>
               </td>
			</tr>	
		</table>
...
<div id="slides">
	<img border="0" class="slidesjs-slide" src='static/tgm3/images//home.jpg' />
</div> 
</fieldset>
</s:else> 
--%>
